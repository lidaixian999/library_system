      ...
      <section class="book-list-section">
        ...
        <div v-else class="book-table">
          <el-table :data="bookList" style="width: 100%" @row-click="showBookDetail">
            ...
            <el-table-column prop="availableCopies" label="库存" width="80" />
        ...
        <el-row :gutter="10">
          ...
          <el-col :span="8">
            <div class="detail-info">
              ...
              <p><span>库存：</span>{{ currentBook.availableCopies }}本</p>
  ...
  <el-col :span="6">
    <el-card shadow="hover">
      ...
      <template #footer>
        ...
        <el-button type="primary" @click="addToCart(currentBook)">借阅</el-button>
      </template>
    </el-dialog>
  </div>
</template>
...
const addToCart = async (book) => {
  try {
    ...
    // 调用借阅接口
    await axios.post('http://localhost:8989/api/borrow/borrow', {
      user_id: userInfo.id,
      book_id: book.id
    })
